  ...
  function clearListHandler(){
    ...
    return (
      <div>
        ...
        <Result key={i} id={movie[2]} isNominated={true} poster={movie[3]} results={props.results} setResults={props.setResults} list={props.list} setList={props.setList} Title={movie[0]} Year={movie[1]} ></Result>
        )
